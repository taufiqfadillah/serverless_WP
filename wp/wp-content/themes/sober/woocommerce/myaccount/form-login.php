...
<h2 class="text-center login-tabs-nav tabs-nav">
	<span class="line-hover tab-nav active" data-tab="login"><?php esc_html_e( 'Login', 'woocommerce' ); ?></span>
	<span class="line-hover tab-nav" data-tab="register"><?php esc_html_e( 'Register', 'woocommerce' ); ?></span>
</h2>
