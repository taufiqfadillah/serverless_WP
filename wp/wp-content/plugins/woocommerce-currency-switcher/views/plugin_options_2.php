...
<div class="subsubsub_section woocs_subsubsub_section">
    ...
    <div class="section">
        ...
        <div class="woocs__section-title woocs-mb-4">
            ...
            <i><?php printf(esc_html__('Maintained for WooCommerce v.%s.x', 'woocommerce-currency-switcher'), esc_html($this->actualized_for)) ?></i>
                                                        ...
                                                        <div class="woocs__alert woocs__alert-success">
                                                            <table class="woocs_settings_promotion" >
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <h6>Botoscope:</h6>
                                                                        <a href="https://wordpress.org/plugins/botoscope/" target="_blank" title="BOTOSCOPE - Bridge your WooCommerce store and Telegram"><img src="<?php echo esc_attr(WOOCS_LINK) ?>img/botoscope.png" style="width: 670px;" alt="<?php esc_html_e("BOTOSCOPE - Bridge your WooCommerce store and Telegram", 'woocommerce-currency-switcher'); ?>" /></a>
                                                                    </td>
