...
export default function StoreUrlMismatchError({
	...
	const handleProductPage = () => {
		...
		window.open("https://admin.shopify.com/products", "_blank", "noopener noreferrer");
	};
			...
			<div className="error-content">
				<div className="error-header">
					...
					<h3 className="error-title">
						{__("Product not connected", "shopify")}
					</h3>
				</div>
				<div className="error-message">
					<p>
						{__(
							"Your product is no longer connected. To reconnect:",
							"shopify"
						)}
					</p>
					<ul className="reconnect-steps">
						...
						<li>
							{__(
								"Review your product in Shopify to confirm it’s linked to the Sell on WordPress sales channel.",
								"shopify"
							)}
						</li>
					</ul>
